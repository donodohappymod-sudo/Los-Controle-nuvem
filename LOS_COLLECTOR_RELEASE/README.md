...
1. Suba **o conteúdo deste projeto na raiz do repositório GitHub**. O pacote mantém as pastas reais do Next.js e também inclui um fallback `prebuild` caso alguma ferramenta de upload achate os nomes.

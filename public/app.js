...
const APP_VERSION='20260919-collector3';window.addEventListener('pageshow',e=>{if(e.persisted)location.reload()});const nav=[['home','⌂','Início'],['sources','🌐','Fontes'],['library','▦','Biblioteca'],['diagnosis','🩺','Diagnóstico'],['monitoring','◉','Monitoramento'],['merge','🔀','Mesclar'],['generated','📡','Fontes Geradas'],['studio','✦','Studio'],['settings','⚙','Configurações'],['ai','🧠','AI / Testes']];
